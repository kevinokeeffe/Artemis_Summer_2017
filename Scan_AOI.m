...
%
    Si_R = importdata('Si_mirror_35-55eV_Reflect.dat');
    Au_R = importdata('Au_mirror_35-55eV_Reflect.dat');
    Au_abs_5 = importdata('Au_7nm_35-55eV_Abs.dat');
    Si_abs_140 = importdata('Si_100nm_35-55eV_Abs.dat'); %ignore the 140, it's for 100 nm
