...
%
Si_R = importdata('Si_mirror_35-55eV_Reflect.dat'); % raw Si reflectivity at normal incidence
Au_R = importdata('Au_mirror_35-55eV_Reflect.dat'); % raw Au reflectivity at normal incidence
Au_abs_5 = importdata('Au_7nm_35-55eV_Abs.dat'); % 7 nm thick Au transmission
Si_abs_140 = importdata('Si_100nm_35-55eV_Abs.dat');% 100 nm thick Si transmission
